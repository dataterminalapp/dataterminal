...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div
        style={{ width: "0.5px", height: "95%" }}
        className="rounded-2xl group-hover:bg-muted-foreground group-data-[resize-handle-active=pointer]:bg-primary transition-colors duration-200"
      />
    )}
  </ResizablePrimitive.PanelResizeHandle>
);
